...
(
    ...
    inner join jsonb_to_recordset($3::jsonb) i(column_name name, column_type regtype, range_start bigint, range_end bigint)
...
where x.nbr_dimension_slices = jsonb_array_length($3::jsonb)
;